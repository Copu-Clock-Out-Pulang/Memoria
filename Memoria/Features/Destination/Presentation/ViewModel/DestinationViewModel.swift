...
class DestinationViewModel: ObservableObject {
    ...
    func createScrapbook() {
        ...
        createScrapBook.execute(params: CreateScrapBookParams(form: CreateScrapBookForm(name: self.tripName ?? "", quote: self.quote ?? "", scrapPages: scrapPages, selectedRecommendations: Array(selected), startDate: self.tripStartDate, endDate: self.tripEndDate)))
            .sink(receiveCompletion: {[weak self] completion in
                switch completion {
                case .finished:
